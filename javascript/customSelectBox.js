        ...
        var hiddenTextBox = document.getElementsByClassName('bar__text_form');
            ...
            option.addEventListener('click', function() {
                if (!this.classList.contains('selected')) {
                    ...
                    if(this.parentNode.getAttribute("data-select-bar-type") == 0){
                        ...
                        hiddenTextBox[0].value = document.getElementsByClassName('bar__-option selected')[0].getAttribute('data-value');
                    } else {
                        ...
                        hiddenTextBox[1].value = document.getElementsByClassName('bar__-option selected')[1].getAttribute('data-value');
                    }                    
                }
            })
        }
